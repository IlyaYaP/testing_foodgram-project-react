...
class SubscriptionsLocators():
    ...
    AUTHOR_UNSUBSCRIBE = (By.XPATH, f'//a[text()="{DataSubscription.AUTHOR}"]\
                                    //following::button[text()="Отписаться"]')
...
class FavouritesLocators():
    FAVOURITE_BUTTON = (By.XPATH, f'//a[text()="{DataFavouries.RECIPE_NAME}"]\
                                                      //following::button[2]')
    FAVOURITE_NAME = (By.XPATH, f'//a[text()="{DataFavouries.RECIPE_NAME}"]')


class ShoppingCartLocators():
    ADD_SHOPPING_CART_BUTTON = (By.XPATH, f'//a[text()=\
                                "{DataShoppingCart.RECIPE_NAME}"]\
                                //following::button[1]')
