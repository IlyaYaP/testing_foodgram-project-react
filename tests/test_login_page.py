...
from data.data_registration import (DataRegistrationAndLoginUser_1,
                                    DataRegistrationAndLoginUser_2)
...
class TestRegistrationForm():
    ...
    @pytest.mark.parametrize(
        'data', [DataRegistrationAndLoginUser_1.valid_data_registration,
    ...
    @allure.story('Негативный тест: Тест регистрации нового пользователя\
                  с использованием невалидных данных.')
    @pytest.mark.registration_negative_test(scope='function')
    @pytest.mark.parametrize(
        'data', [DataRegistrationAndLoginUser_1
                 .invalid_data_registration_username_email,
                 DataRegistrationAndLoginUser_1
                 .invalid_data_registration_pass])
...
class TestLoginForm():
    ...
    @allure.story('Негативный тест: Тест аутентификации с\
                  использованием невалидных данных.')
    ...
    @allure.story('Негативный тест: Тест аутентификации\
